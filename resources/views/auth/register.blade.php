        ...
        <section class="px-5 sm:px-20 py-10 flex flex-col">
            ...
            <form action="/register" method="POST" class="border border-gray-500 rounded-md w-full sm:w-96 self-center mt-8 p-6">
                ...
                <div class="flex flex-col">
                    ...
                    <input type="text" name="name" id="name" class="py-1 rounded-sm" required>
                </div>
                <div class="flex flex-col mt-3">
                    <label for="email" class="text-sm">Email</label>
                    <input type="email" name="email" id="email" class="py-1 rounded-sm" required>
                </div>
                <div class="flex flex-col mt-3">
                    <label for="password" class="text-sm">Password</label>
                    <input type="password" name="password" id="password" class="py-1 rounded-sm" minlength="8" required>
                </div>
                <div class="flex flex-col mt-3">
                    <label for="password-confirmation" class="text-sm">Konfirmasi Password</label>
                    <input type="password" name="password_confirmation" id="password-confirmation" class="py-1 rounded-sm" minlength="8" required>
                </div>
